...
namespace Smooth
{
    ...
    public class NetworkState : MessageBase
    {
        ...
        {
            bool sendPosition, sendRotation, sendScale, sendVelocity, sendAngularVelocity, sendTeleportTag, sendAtPositionalRestTag, sendAtRotationalRestTag;
            ...
            else // If is a server or client trying to send owned object information across the network.
            {
                ...
                sendTeleportTag = smoothSync.sendTeleportMessage;
            ...
            writer.Write(encodeSyncInformation(sendPosition, sendRotation, sendScale,
                sendVelocity, sendAngularVelocity, sendTeleportTag, sendAtPositionalRestTag, sendAtRotationalRestTag));
        ...
        /// <summary>
        /// Hardcoded information to determine whether should teleport instead of lerping.
        /// </summary>
        byte teleportMask = 32; // 0010_0000
        /// <summary>
        ...
        /// </summary>
        byte encodeSyncInformation(bool sendPosition, bool sendRotation, bool sendScale, bool sendVelocity, bool sendAngularVelocity, bool teleport, bool atPositionalRest, bool atRotationalRest)
        {
            byte encoded = 0;
            ...
            if (teleport)
            {
                encoded = (byte)(encoded | teleportMask);
            }
            if (atPositionalRest)
            {
        ...
        /// <summary>
        /// Decode sync info to see if we want to teleport.
        /// </summary>
        bool shouldTeleport(byte syncInformation)
        {
            if ((syncInformation & teleportMask) == teleportMask)
            {
                return true;
            }
            else
